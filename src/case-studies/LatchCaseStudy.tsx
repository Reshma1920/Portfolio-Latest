...
const RESEARCH_OVERVIEW_COLUMNS: ResearchOverviewColumn[] = [
  {
    ...
    imageSrc: '/latch-primary-research-charts.png',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/latch-affinity-mapping-notes.png',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/latch-validation-prototype.png',
    imageAlt:
...
function LatchUserResearchPanelContent({
  statInterviews,
  statManual,
}: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:items-stretch">
          <div className="flex min-h-[380px] min-w-0 flex-col border-b border-dotted border-[#b0b0a8] lg:h-full lg:min-h-0 lg:border-b-0 lg:border-r lg:border-dotted lg:border-[#b0b0a8]">
            <ImagePlaceholder
              ...
              fillHeight
              noBorder
              backgroundCoverSrc="/latch-affinity-mapping-notes.png"
...
function LatchCompetitiveAnalysisPanelContent() {
  return (
    <>
...
function LatchUserJourneyPanelContent() {
  return (
    <>
      <h2 className={`${inDepthPanelTitleClass} mb-6`}>
    ...
    <section className="px-6 pb-6 pt-8 sm:px-8">
      ...
      <div className="mt-4 border border-dotted border-[#b0b0a8] bg-transparent">
        ...
        <CaseStudyAccordionItem title="2.2. Competitor Analysis">
          <LatchCompetitiveAnalysisPanelContent />
        </CaseStudyAccordionItem>
        <CaseStudyAccordionItem title="2.3. User Journey Explorations">
          <LatchUserJourneyPanelContent />
        </CaseStudyAccordionItem>
      </div>
    </section>
  )
...
const FINAL_DESIGN_PANELS = [
  {
    ...
    imageSrc: '/latch-workflow-capture.png',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/latch-revisit-rerecord.png',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/latch-wrap-up-summary.png',
    imageAlt:
...
const latchDescription =
  'UX case study (in progress): Latch by Superlabs — designing a voice and recording-led setup flow so non-technical teams can automate workflows without IT-heavy implementations.'
...
const FEATURE_COLUMNS = [
  {
    ...
    imageSrc: '/latch-features-non-intrusive-interface.png',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/latch-features-flexibility-control.png',
    imageAlt:
...
const PRIVACY_FEATURES: PrivacyFeature[] = [
  {
    ...
    imageSrc: '/latch-privacy-watches-screen.png',
  ...
  },
  {
    ...
    imageSrc: '/latch-privacy-listens.png',
  ...
  },
  {
    ...
    imageSrc: '/latch-privacy-follows-clicks.png',
...
export default function LatchCaseStudy() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-visible bg-[#F7F6F2] text-foreground antialiased">
      <Helmet>
        ...
        <meta property="og:title" content="Latch — Superlabs | UX Case Study | Reshma Lokanathan" />
        <meta property="og:description" content={latchDescription} />
        <meta property="og:url" content="https://reshmalokanathan.com/latch" />
        ...
        <section className={CASE_STUDY_SECTION_INNER_CLASS}>
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-[7fr_3fr] lg:items-stretch lg:gap-10">
            <ImagePlaceholder
              ...
              imageSrc="/latch-agent-behavior-settings.png"
